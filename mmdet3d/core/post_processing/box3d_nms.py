...
def box3d_allclass_nms(mlvl_bboxes,
                       mlvl_bboxes_for_nms,
                       mlvl_scores,
                       score_thr,
                       max_num,
    ...
    _scores, cls_label = torch.max(mlvl_scores, dim=-1)
    cls_inds = _scores > score_thr
    _bboxes_for_nms = mlvl_bboxes_for_nms[cls_inds, :]
    _scores = _scores[cls_inds]
    ...
    labels.append(cls_label[selected])
